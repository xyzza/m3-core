...
DefaultGroupName=m3
DisableProgramGroupPage=yes
;InfoBeforeFile=C:\Documents and Settings\РђРґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ\Р Р°Р±РѕС‡РёР№ СЃС‚РѕР»\src\InfoBeforeInstall.txt
;InfoAfterFile=C:\Documents and Settings\РђРґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ\Р Р°Р±РѕС‡РёР№ СЃС‚РѕР»\src\InfoAfterInstall.txt
OutputDir=C:\Documents and Settings\РђРґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ\Р Р°Р±РѕС‡РёР№ СЃС‚РѕР»
OutputBaseFilename=setup
Compression=lzma
SolidCompression=yes
...
[Run]
Filename: msiexec.exe; Parameters: "/i ""{tmp}\python-2.6.4.msi"""; Flags: skipifsilent; Components: install_python; StatusMsg: РЈСЃС‚Р°РЅРѕРІРєР° Python...
Filename: {tmp}\postgresql-8.4.2-1-windows.exe; Flags: skipifsilent; Parameters: {code:GetPostgreInstalParameters}; Check: CheckInstallDataManage(ExpandConstant('{cm:Postgre}')); StatusMsg: РЈСЃС‚Р°РЅРѕРІРєР° PostgreSQL...
Filename: {tmp}\psycopg2-2.0.13.win32-py2.6-pg8.4.1-release.exe; StatusMsg: РЈСЃС‚Р°РЅРѕРІРєР° Psycopg2...
Filename: {code:GetPythonInstallPath}\python; Components: " install_project"; Check: CheckPythonExists(True); Parameters: {code:GetScriptParameters}; StatusMsg: РќРµ Р·Р°РєСЂС‹РІР°Р№С‚Рµ РґРѕС‡РµСЂРЅРµРµ РѕРєРЅРѕ! РРґРµС‚ СѓСЃС‚Р°РЅРѕРІРєР° РїСЂРёР»РѕР¶РµРЅРёСЏ...
;"{tmp}\setup.py -p ""{app}"" -s ""{tmp}/m3project.zip"" -t 1 -d postgre --host locagHost --port 5432 --user django --password django --superuser postgres --db-name m3 --superpassword 123"

[Components]
Name: install_python; Description: РЈСЃС‚Р°РЅРѕРІРёС‚СЊ Python 2.6.4; Languages: ; Types: custom; Flags: fixed; Check: not CheckPythonExists(False)
;Name: install_postrgre; Description: РЈСЃС‚Р°РЅРѕРІРёС‚СЊ PostgreSQL 8.4.2; Types: custom; Languages: ; Flags: checkablealone; Check: not CheckPostgreExists
Name: install_project; Description: M3 project; Flags: fixed; Types: custom
Name: i_mysql; Description: РСЃРїРѕР»СЊР·РѕРІР°С‚СЊ MySQL; Types: custom; Flags: exclusive checkablealone
Name: i_oracle; Description: РСЃРїРѕР»СЊР·РѕРІР°С‚СЊ Oracle; Flags: exclusive checkablealone; Types: custom
Name: i_postgre; Description: РСЃРїРѕР»СЊР·РѕРІР°С‚СЊ PostgreSQL; Flags: exclusive checkablealone; Types: custom

[Types]
Name: custom; Description: РџРѕР»РЅР°СЏ СѓСЃС‚Р°РЅРѕРІРєР°; Flags: iscustom

[CustomMessages]
; РїРѕРґРґРµСЂР¶РёРІР°РµРјС‹Рµ РЎРЈР‘Р”:
Postgre = postgre
Oracle  = oracle
MySql   = mysql
Sqlite  = sqlite
...
[Code]
const
  // РўРёРї РёРЅСЃС‚Р°Р»СЏС†РёРё:
	TYPE_INSTALL = 1; // 1 -- full install, 2 -- update version, 3 -- update build
	
  // РЈСЃС‚Р°РЅР°РІР»РёРІР°РµРјС‹Рµ РІРµСЂСЃРёРё:
  PYTHON_VER = '2.6';
	// POSTGRE_VER = '8.4';

	// Р’ РїСЂРѕС†РµРґСѓСЂР°С… РЅРµР»СЊР·СЏ РѕР±СЉСЏРІР»СЏС‚СЊ РєРѕРЅСЃС‚Р°РЅС‚С‹... РїРїС†
	// x -- РѕС‚СЃС‚СѓРї РєРѕРЅС‚СЂРѕР»Р° РѕС‚ Р»РµРІРѕРіРѕ РєСЂР°СЏ
	// y -- РѕС‚СЃС‚СѓРї РєРѕРЅС‚СЂРѕР»Р° РѕС‚ РІРµСЂС…РЅРµРіРѕ РєСЂР°СЏ, РѕС‚СЃС‚СѓРї РјРµР¶РґСѓ РєРѕРЅС‚СЂРѕР»Р°РјРё РїРѕ РѕСЃРё Y
	// h -- РІС‹СЃРѕС‚Р° РїР°РЅРµР»Рё
	// w -- С€РёСЂРёРЅР° РїР°РЅРµР»Рё
	X = 5;
	Y = 5;
	H = 170;
	W = 200;

	LABEL_W  = 20;   // С€РёСЂРёРЅР° РјРµС‚РєРё
	EDIT_W   = 120;  // С€РёСЂРёРЅР° Edita
	EDIT_X   = 70;   // РѕС‚СЃС‚СѓРї СЃР»РµРІР° Edita

var
  // РєР°СЃС‚РѕРјРЅР°СЏ СЃС‚СЂР°РЅРёС†Р° РЅР°СЃС‚СЂРѕРµРє СЃСѓР±Рґ
	SettingsDbPage: TInputQueryWizardPage;

  // РіР»РѕР±Р°Р»СЊРЅС‹Рµ РїР°СЂР°РјРµС‚СЂС‹ РЅР° РєР°СЃС‚РѕРјРЅРѕР№ СЃС‚СЂР°РЅРёС†Рµ РїРѕРґРєР»СЋС‡РµРЅРёСЏ Рє Р±Рґ
  gInstallDM : TNewCheckBox;
  gHost,
	gPort,
	gUser,
...
begin
	...
	// Р’ Р·Р°РІРёСЃРёРјРѕСЃС‚Рё РѕС‚ С‚РёРїР° СѓСЃС‚Р°РЅРѕРІРєРё СЌС‚РѕС‚ РіР°Рґ СѓСЃС‚Р°РЅР°РІР»РёРІР°РµС‚СЃСЏ РІ СЂР°Р·РЅС‹Рµ РєРѕСЂРЅРё СЂРµРµСЃС‚СЂР°.
	if RegKeyExists(HKEY_CURRENT_USER, 'SOFTWARE\Python\PythonCore\' + PYTHON_VER + '\InstallPath') then begin
		// РјРѕР¶РЅРѕ РµС‰Рµ РґРѕР±Р°РІРёС‚СЊ РІС‹Р·РѕРІ РїРёС‚РѕРЅР° С‡РµСЂРµР· try Рё РєР»СЋС‡ СЂРµРµСЃС‚СЂР° InstallPath
		Result := True; // РЈСЃС‚Р°РЅРѕРІР»РµРЅ РЅРѕ РІ silent СЂРµР¶РёРјРµ... РњРѕРіСѓС‚ Р±С‹С‚СЊ РїСЂРѕР±Р»РµРјС‹ СЃ РёРјРїРѕСЂС‚РѕРј psycopg2
	end
	else if RegKeyExists(HKEY_LOCAL_MACHINE, 'SOFTWARE\Python\PythonCore\' + PYTHON_VER + '\InstallPath') then begin
		Result := True; // РЈСЃС‚Р°РЅРѕРІР»РµРЅ РІ РіСЂРѕРјРєРѕРј СЂРµР¶РёРјРµ
	end;
	if  CheckForScript and not Result then
	   MsgBox('Python ' + PYTHON_VER + ' РЅРµ СѓСЃС‚Р°РЅРѕРІР»РµРЅ!',mbError,MB_OK);
end;

// РґРѕР±С‹РІР°РµС‚ РїСѓС‚СЊ Рє РїР°РїРєРµ РіРґРµ Р»РµР¶РёС‚ python
function GetPythonInstallPath(AParam: String):string;
var
	lPythonInstallPath: string;
begin
...
// Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃС‚СЂРѕРєСѓ СЃ РЅР°Р·РІР°РЅРёРµРј РЎРЈР‘Р”
function GetPostgre():string;
begin
  Result:= ExpandConstant('{cm:Postgre}');
end;
...
// РІРѕР·РІСЂР°С‰Р°РµС‚ РІС‹Р±СЂРѕРЅРЅСѓСЋ РЎРЈР‘Р”
function GetChosenDataManage(): string;
begin
  if IsComponentSelected('i_mysql') then begin
      Result:= GetMySql();
...
// Р¤РѕСЂРјРёСЂСѓРµС‚ Рё РІРѕР·РІСЂР°С‰Р°РµС‚ СЃС‚СЂРѕРєСѓ РїР°СЂР°РјРµС‚СЂРѕРІ РёРЅСЃС‚Р°Р»СЏС†РёРё Postgre
function GetPostgreInstalParameters(AParam: String):string;
begin
  Result:= '--unattendedmodeui minimal --superpassword ' + gSuperPass.Text + ' --serverport ' + gPort.Text + ' --superaccount ' + gSuperUser.Text;
end;

// Р¤РѕСЂРјРёСЂСѓРµС‚ Рё РІРѕР·РІСЂР°С‰Р°РµС‚ СЃС‚СЂРѕРєСѓ РїР°СЂР°РјРµС‚СЂРѕРІ РёРЅСЃС‚Р°Р»СЏС†РёРё РґР»СЏ setup.py
function GetScriptParameters(AParam: string): string;
begin
	 Result := ExpandConstant('{tmp}') + '\setup.py -p "' + ExpandConstant('{app}')
		+ '" -s "' + ExpandConstant('{tmp}') +'\m3project.zip" -t ' + IntToStr(TYPE_INSTALL) + ' -d ' + GetPostgre()
...
// РЈСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ Р·РЅР°С‡РµРЅРёСЏ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ РґР»СЏ РІС‹Р±СЂР°РЅРЅС‹С… РЎРЈР‘Р”
procedure SetDefaultDataManageParameters();
begin
    if IsComponentSelected('i_mysql') then begin
        gInstallDM.Caption:= 'РЈСЃС‚Р°РЅРѕРІРёС‚СЊ My SQL';
        SettingsDbPage.Caption := 'РСЃРїРѕР»СЊР·РѕРІР°РЅРёРµ My SQL';
        SettingsDbPage.Description := 'РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ РїРѕРґРєР»СЋС‡РµРЅРёСЏ Рє My SQL';
        gPort.Text := '3306';
        gStaticText.Caption := 'РџСЂРё СѓСЃС‚Р°РЅРѕРІРєРµ Mysql' +#13#10 + 'РѕСЃС‚Р°РІСЊС‚Рµ РїРѕР»СЏ РџРѕСЂС‚ Рё РџР°СЂРѕР»СЊ' +#13#10 + 'РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ!';
    end
    else if IsComponentSelected('i_oracle') then begin
        gInstallDM.Caption:= 'РЈСЃС‚Р°РЅРѕРІРёС‚СЊ Oracle';
        SettingsDbPage.Caption := 'РСЃРїРѕР»СЊР·РѕРІР°РЅРёРµ Oracle';
        SettingsDbPage.Description := 'РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ РїРѕРґРєР»СЋС‡РµРЅРёСЏ Рє Oracle';
        gPort.Text := '1521';
        gStaticText.Caption := 'РџСЂРё СѓСЃС‚Р°РЅРѕРІРєРµ Oracle' + #13#10 + 'РѕСЃС‚Р°РІСЊС‚Рµ РїРѕР»СЏ РџРѕСЂС‚ Рё РџР°СЂРѕР»СЊ' +#13#10 + 'РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ!';
    end
    else if IsComponentSelected('i_postgre') then begin
        gInstallDM.Caption:= 'РЈСЃС‚Р°РЅРѕРІРёС‚СЊ PostgreSQL';
        SettingsDbPage.Caption := 'РСЃРїРѕР»СЊР·РѕРІР°РЅРёРµ PostgreSQL';
        SettingsDbPage.Description := 'РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ РїРѕРґРєР»СЋС‡РµРЅРёСЏ Рє PostgreSQL';
        gPort.Text := '5432';
        gStaticText.Caption := 'РџСЂРё СѓСЃС‚Р°РЅРѕРІРєРµ Postgre' +#13#10 + 'РѕСЃС‚Р°РІСЊС‚Рµ РїРѕР»СЏ РџРѕСЂС‚ Рё РџР°СЂРѕР»СЊ' +#13#10 + 'РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ!';
    end;
end;
...
begin
	...
	gInstallDM := TNewCheckBox.Create(SettingsDbPage);
	gInstallDM.Caption:= 'РЈСЃС‚Р°РЅРѕРІРёС‚СЊ ';
	gInstallDM.State 	:= cbChecked;
	gInstallDM.Parent := SettingsDbPage.Surface;
	gInstallDM.Width 	:= SettingsDbPage.SurfaceWidth;
	gInstallDM.Align 	:= alTop;
	...
	// Description:
	lParamLabel := TLabel.Create(lPanel);
	lParamLabel.Caption   := 'РџР°СЂР°РјРµС‚СЂС‹ РїРѕРґРєР»СЋС‡РµРЅРёСЏ:';
	lParamLabel.Top 	    := ScaleX(Y);
	lParamLabel.Width 	  := ScaleY(LABEL_W);
	lParamLabel.Left 	    := ScaleY(X);
	lParamLabel.Parent 	  := lPanel;
	...
	// host -- РїРѕРґРєР»СЋС‡РµРЅРёРµ Рє Р±Рґ
	gHostLabel := TLabel.Create(lPanel);
	gHostLabel.Caption:= 'РђРґСЂРµСЃ:';
	gHostLabel.Top 		:= lParamLabel.Top + lParamLabel.Height + Y + 5;
	gHostLabel.Width 	:= ScaleY(LABEL_W);
	gHostLabel.Left 	:= ScaleY(X);
	gHostLabel.Parent := lPanel;
	...
	// РџРѕСЂС‚ -- РїРѕРґРєР»СЋС‡РµРЅРёРµ Рє Р±Рґ
	gPortLabel := TLabel.Create(lPanel);
	gPortLabel.Caption:= 'РџРѕСЂС‚:';
	gPortLabel.Top 		:= gHostLabel.Top + gHostLabel.Height + Y + 7;
	gPortLabel.Width 	:= ScaleY(LABEL_W);
	gPortLabel.Left 	:= ScaleY(X);
	gPortLabel.Parent := lPanel;
	...
	// Р®Р·РµСЂ -- РїРѕРґРєР»СЋС‡РµРЅРёРµ Рє Р±Рґ
	gUserLabel := TLabel.Create(lPanel);
	gUserLabel.Caption 	:= 'Р›РѕРіРёРЅ:';
	gUserLabel.Top 		:= gPortLabel.Top + gPortLabel.Height + Y + 7;
	gUserLabel.Width 	:= ScaleY(LABEL_W);
	gUserLabel.Left 	:= ScaleY(X);
	gUserLabel.Parent := lPanel;
	...
	// РџР°СЂРѕР»СЊ
	gPassLabel := TLabel.Create(lPanel);
	gPassLabel.Caption:= 'РџР°СЂРѕР»СЊ:';
	gPassLabel.Top 		:= gUserLabel.Top + gUserLabel.Height + Y + 7;
	gPassLabel.Width 	:= ScaleY(LABEL_W);
	gPassLabel.Left 	:= ScaleY(X);
	gPassLabel.Parent := lPanel;
	...
	// РРјСЏ Р±Р°Р·С‹ -- РїРѕРґРєР»СЋС‡РµРЅРёРµ Рє Р±Рґ
	gDBNameLabel := TLabel.Create(lPanel);
	gDBNameLabel.Caption 	:= 'РРјСЏ Р±Р°Р·С‹:';
	gDBNameLabel.Top 		  := gPassLabel.Top + gPassLabel.Height + Y + 7;
	gDBNameLabel.Width 		:= ScaleY(LABEL_W);
	gDBNameLabel.Left 		:= ScaleY(X);
	gDBNameLabel.Parent 	:= lPanel;
	...
	// РџР°РЅРµР»СЊ РґР»СЏ РїР°СЂР°РјРµС‚СЂРѕРІ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°
	lPanelAdmin := TPanel.Create(SettingsDbPage);
	lPanelAdmin.Parent 	:= SettingsDbPage.Surface;
	lPanelAdmin.Top		:= gInstallDM.Top + gInstallDM.Height + Y;
	lPanelAdmin.Left	:= W + Y;
	...
	// РћРїРёСЃР°РЅРёРµ РїР°РЅРµР»Рё Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°:
	lParamLabelAdmin := TLabel.Create(lPanelAdmin);
	lParamLabelAdmin.Caption := 'РџР°СЂР°РјРµС‚СЂС‹ Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°:';
	lParamLabelAdmin.Top 	:= ScaleX(Y);
	lParamLabelAdmin.Width 	:= ScaleY(LABEL_W);
	lParamLabelAdmin.Left 	:= ScaleY(X);
	lParamLabelAdmin.Parent := lPanelAdmin;
	...
	// Р®Р·РµСЂ -- РїРѕРґРєР»СЋС‡РµРЅРёРµ Рє Р±Рґ
	gSuperUserLabel := TLabel.Create(lPanelAdmin);
	gSuperUserLabel.Caption := 'Р›РѕРіРёРЅ:';
	gSuperUserLabel.Top 	  := lParamLabelAdmin.Top + lParamLabelAdmin.Height + Y + 5;
	gSuperUserLabel.Width 	:= ScaleY(LABEL_W);
	gSuperUserLabel.Left 	  := ScaleY(X);
	gSuperUserLabel.Parent 	:= lPanelAdmin;
	...
	// РџР°СЂРѕР»СЊ
	gSuperPassLabel := TLabel.Create(lPanelAdmin);
	gSuperPassLabel.Caption  := 'РџР°СЂРѕР»СЊ:';
	gSuperPassLabel.Top 	   := gSuperUserLabel.Top + gSuperUserLabel.Height + Y + 7;
	gSuperPassLabel.Width 	 := ScaleY(LABEL_W);
	gSuperPassLabel.Left 	   := ScaleY(X);
	gSuperPassLabel.Parent 	 := lPanelAdmin;
	...
	// РўРµРєСЃС‚, РІС‹РІРѕРґСЏС‰РёР№ РЅРµРєСѓСЋ РёРЅС„РѕСЂРјР°С†РёСЋ РїРѕР»СЊР·РѕРІР°С‚РµР»СЋ
  gStaticText         := TNewStaticText.Create(lPanelAdmin);
  gStaticText.Top     := gSuperPass.Top + gSuperPass.Height + ScaleY(Y)*3;
  gStaticText.Height  := 100;
  gStaticText.Left    := ScaleY(X)*3
...
var
	lErrorStr, lUseDataBase: string;
begin
	lErrorStr:= 'Р‘С‹Р»Рё РЅР°Р№РґРµРЅС‹ СЃР»РµРґСѓСЋС‰РёРµ РѕС€РёР±РєРё:' + #13#10;
	Result := True;
	if CurPageID = SettingsDbPage.ID then begin
		if gHost.Text = '' then begin
			lErrorStr:= lErrorStr + 'РќРµ Р·Р°РїРѕР»РЅРµРЅРѕ РїРѕР»Рµ "РђРґСЂРµСЃ"!' +#13#10;
			Result:= False;
		end;
		if gPort.Text = '' then begin
			lErrorStr:= lErrorStr + 'РќРµ Р·Р°РїРѕР»РЅРµРЅРѕ РїРѕР»Рµ "РџРѕСЂС‚"!' +#13#10;
			Result:= False;
		end;
		if gUser.Text = '' then begin
			lErrorStr:= lErrorStr + 'РќРµ Р·Р°РїРѕР»РЅРµРЅРѕ РїРѕР»Рµ  "Р›РѕРіРёРЅ"!' +#13#10;
			Result:= False;
		end;
		if gDBName.Text = '' then begin
			lErrorStr:= lErrorStr + 'РќРµ Р·Р°РїРѕР»РЅРµРЅРѕ РїРѕР»Рµ "РРјСЏ Р±Р°Р·С‹"!' +#13#10;
			Result:= False;
		end;
		if gSuperUser.Text = '' then begin
			lErrorStr:= lErrorStr + 'РќРµ Р·Р°РїРѕР»РЅРµРЅРѕ РїРѕР»Рµ "Р›РѕРіРёРЅ" Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂР°!' +#13#10;
			Result:= False;
		end;
...
// РџСЂРѕРІРµСЂРєР°: РќСѓР¶РЅРѕ Р»Рё СѓСЃС‚Р°РЅР°РІР»РёРІР°С‚СЊ РЎРЈР‘Р”
function CheckInstallDataManage(AType: string): Boolean;
begin
    Result:= False;
    if (gInstallDM.Checked) and (GetChosenDataManage() = AType) then begin
