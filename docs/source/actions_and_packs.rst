...
Экшены, паки и механизм обработки запросов М3 (m3.ui.actions)
=============================================================
...
Для ограничения доступа к action-ам и pack-ам имеется атрибут ``need_check_permission``.
По умолчанию значение этого атрибута класса равно ``False``.

Помимо стандартных прав имеется возможность задать свои специфические права. Это делается путем задания
словаря ``sub_permissions``: ::

    class MyAction(Action):
        ...
        sub_permissions = {'edit':u'Редактирование записи'}
        ...
