...
def to_source(node, indent_with=' ' * 4, add_line_information=False, indentation=0): # A prefer 21.04: add indentation parameter
    ...
    generator.indentation = indentation
...
class SourceGenerator(NodeVisitor):
    ...
    def visit_StringSpaces(self, node):        
        self.newline(extra=node.lines-1)
        self.write('')
