...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContragentAddress.house'
        db.add_column('m3_contragent_addresses', 'house', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'ContragentAddress.building'
        db.add_column('m3_contragent_addresses', 'building', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'ContragentAddress.flat'
        db.add_column('m3_contragent_addresses', 'flat', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContragentAddress.house'
        db.delete_column('m3_contragent_addresses', 'house')

        # Deleting field 'ContragentAddress.building'
        db.delete_column('m3_contragent_addresses', 'building')

        # Deleting field 'ContragentAddress.flat'
        db.delete_column('m3_contragent_addresses', 'flat')
