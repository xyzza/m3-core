...
class ReportParamsWindow(ExtWindow):
    ...
    def __init__(self, types, default_type_value, *args, **kwargs):
    ...
    def initialize(self):
        ...
        frm_form.items.extend([hdn_id, str_param_name, cmb_type, cmb_value_type])
