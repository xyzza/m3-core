...
class ReportBuilderWindow(ExtWindow):
    ...
    def initialize(self):
        ...
        btn_button_1.handler = 'save'
        
        btn_button_2 = ExtButton()
        btn_button_2.text = u'Отмена'
        btn_button_2.handler = 'function(){win.close();}'
        
        cnt_north = ExtContainer()
        cnt_north.layout = 'form'
        cnt_north.region = 'north'
        cnt_north.height = 40
        cnt_north.label_width = 50
        cnt_north.anchor = '100%'
        cnt_north.style = {'padding': '5px'}
        ...
        grd_params.columns.extend([clmn_name, clmn_type, clmn_value_type])
        frm_form.items.extend([hdn_id, str_name, dsf_query])
        self.items.extend([cnt_north, grd_params, frm_form])
        
        self.tb_buttons = tb_buttons
        self.btn_button_1 = btn_button_1
        self.btn_button_2 = btn_button_2
        self.cnt_north = cnt_north
