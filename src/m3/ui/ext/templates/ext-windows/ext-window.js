...
Ext.ux.SelectFilter = Ext.extend(Ext.form.ComboBox,
{
    ...
    constructor: function(config)
    {
        ...
        this.fieldLabel = this.filterTitle;
        this.emptyText = '-- ' + this.filterTitle + ' --';
...
var filterPanel = new Ext.ux.FilterPanel({
    ...
    filters : [{
        filterID : 'Date',
        filterType : 'date', // Creates a DateField control to select the value of the filter
        filterTitle : 'Дата'},
	{
        filterID : 'state', // Matches field name in stoTest this filter needs to filter on
        filterType : 'text', // Creates a TextField to enter the value of the filter
        wndLabelWidth : 125,
        filterTitle : 'Состояние'}, // LabelField for filter control
    {
        filterID : 'service',
        filterType : 'text', 
        filterTitle : 'Услуга',
	...
	{
        filterID : 'doctor',
        filterType : 'select', // Creates a ComboBox to select the value of the filter
        filterTitle : 'Врач',
        url : 'actions/dicts/select-user/rows', // Method to call for lazy loading
        width : 300},
	{
        filterID : 'point',
        filterType : 'text', 
        filterTitle : 'Рабочее место',
		wndLabelWidth : 125}	
    ]
});