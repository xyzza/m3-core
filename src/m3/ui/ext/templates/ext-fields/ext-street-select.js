(function(){
	var place_combo = new Ext.form.ComboBox({
		...
		,resizable: true
		{% if component.place_client_id %} ,place_client_id:'{{component.place_client_id}}' {% endif %}
		{% if component.t_render_listeners %}
			...
			,listeners:{
				...
				,beforequery: function(qe){
    				...
    				store.baseParams.place_code = '';
					var place_combo = Ext.getCmp(qe.combo.place_client_id);
					store.baseParams.place_code = place_combo.value;
				}
			}
		{% endif %}
	});
