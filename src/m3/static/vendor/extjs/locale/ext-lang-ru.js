...
Ext3.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Идет загрузка...</div>';

if(Ext3.View){
  Ext3.View.prototype.emptyText = "";
}

if(Ext3.grid.GridPanel){
  Ext3.grid.GridPanel.prototype.ddText = "{0} выбранных строк";
}

if(Ext3.TabPanelItem){
  Ext3.TabPanelItem.prototype.closeText = "Закрыть эту вкладку";
}

if(Ext3.form.Field){
  Ext3.form.Field.prototype.invalidText = "Значение в этом поле неверное";
}

if(Ext3.LoadMask){
  Ext3.LoadMask.prototype.msg = "Загрузка...";
}
...
if(Ext3.util.Format){
  Ext3.util.Format.date = function(v, format){
    if(!v) return "";
...
if(Ext3.DatePicker){
  Ext3.apply(Ext3.DatePicker.prototype, {
    todayText          : "Сегодня",
...
if(Ext3.PagingToolbar){
  Ext3.apply(Ext3.PagingToolbar.prototype, {
...
if(Ext3.form.TextField){
  Ext3.apply(Ext3.form.TextField.prototype, {
...
if(Ext3.form.NumberField){
  Ext3.apply(Ext3.form.NumberField.prototype, {
...
if(Ext3.form.DateField){
  Ext3.apply(Ext3.form.DateField.prototype, {
...
if(Ext3.form.ComboBox){
  Ext3.apply(Ext3.form.ComboBox.prototype, {
...
if(Ext3.form.HtmlEditor){
  Ext3.apply(Ext3.form.HtmlEditor.prototype, {
...
if(Ext3.form.BasicForm){
  Ext3.form.BasicForm.prototype.waitTitle = "Пожалуйста подождите...";
}

if(Ext3.grid.GridView){
  Ext3.apply(Ext3.grid.GridView.prototype, {
...
if(Ext3.grid.GroupingView){
  Ext3.apply(Ext3.grid.GroupingView.prototype, {
...
if(Ext3.grid.PropertyColumnModel){
  Ext3.apply(Ext3.grid.PropertyColumnModel.prototype, {
    nameText   : "Название",
    valueText  : "Значение",
    dateFormat : "d.m.Y"
  });
...
if(Ext3.SplitLayoutRegion){
  Ext3.apply(Ext3.SplitLayoutRegion.prototype, {
    splitTip            : "Тяните для изменения размера.",
    collapsibleSplitTip : "Тяните для изменения размера. Двойной щелчок спрячет панель."
  });
}

if(Ext3.layout.BorderLayout && Ext3.layout.BorderLayout.SplitRegion){
  Ext3.apply(Ext3.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Тяните для изменения размера.",
    collapsibleSplitTip : "Тяните для изменения размера. Двойной щелчок спрячет панель."
  });
}
