...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('sentry', ['Index'])

        # Adding unique constraint on 'Index', fields ['app_label', 'module_name', 'column', 'value', 'object_id']
        db.create_unique('sentry_index', ['app_label', 'module_name', 'column', 'value', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Index', fields ['app_label', 'module_name', 'column', 'value', 'object_id']
        db.delete_unique('sentry_index', ['app_label', 'module_name', 'column', 'value', 'object_id'])

        # Deleting model 'Index'
        db.delete_table('sentry_index')
