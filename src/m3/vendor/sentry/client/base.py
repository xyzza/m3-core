...
class SentryClient(object):
    ...
    def create_from_exception(self, exc_info=None, **kwargs):
        ...
        #изменено Гусевым Данилом Барс групп чтоб в лог писался урл а не абстрактая вьюшка (в м3 их мало и они ни оче не говорят)
        try:
            kwargs['view'] = kwargs['request'].get_full_path()
        except:
